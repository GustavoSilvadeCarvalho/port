    ...
    return (
        <div className="w-full max-w-7xl flex">
            <div className="flex flex-col gap-4">
                <h2 className="text-6xl font-bold text-white">Desenvolvendo experiências web completas, do servidor à tela.</h2>
                <h3 className="text-xl text-white">Eu sou Gustavo Silva, Desenvolvedor Full Stack.</h3>
                <p className="text-lg text-white">Apaixonado por transformar desafios em soluções web elegantes e funcionais.</p>
                <div className="gap-4 flex">
                    <button className="bg-transparent max-w-lg border border-neutral-600/50 text-white px-8 py-4 rounded-2xl">Ver Projetos</button>
