...
export default function Hero() {
    return (
        <div className="w-full max-w-90 sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-7xl lg:flex pt-50">
            <div className="text-center lg:text-left flex flex-col gap-4 xl:gap-7">
