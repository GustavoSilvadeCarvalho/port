...
export default function Header() {
    return (
        <header className="w-full max-w-7xl max-h-20 mt-2 flex items-center justify-between px-8 py-4 bg-black text-white border border-neutral-600/50 rounded-2xl bg-gradient-to-b from-neutral-900/80 to-neutral-900/60 backdrop-blur-2xl">
