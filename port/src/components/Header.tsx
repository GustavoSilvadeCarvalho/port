...
export default function Header() {
    ...
    return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-90 sm:max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-6xl max-h-20 flex items-center justify-between px-4 sm:px-8 py-4 text-white border border-neutral-600/50 rounded-2xl bg-gradient-to-b from-neutral-900/70 to-neutral-900/60 backdrop-blur-lg">
            ...
            <nav className="hidden sm:flex flex-1 gap-8 items-center justify-center">
                <a href="#home" className="hover:text-gray-400 transition">Home</a>
                <a href="#about" className="hover:text-gray-400 transition">Sobre</a>
                <a href="#projects" className="hover:text-gray-400 transition">Projetos</a>
            </nav>
